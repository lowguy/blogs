var app = new Vue({
    ...
    methods: {
        ...
        login:function () {
            ...
            this.$http.post(_this.domain+'site/login',{"user_name":this.user_name,"user_pwd":this.user_pwd},{emulateJSON:true}).then((res) => {
        ...
        getLists:function () {
            ...
            var storage = window.localStorage
            var token = storage.getItem('token');
            this.$http.post(_this.domain+'play/lists',{"token":token},{emulateJSON:true}).then((res) => {
